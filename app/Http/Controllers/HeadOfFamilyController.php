...
class HeadOfFamilyController extends Controller implements HasMiddleware
{
    ...
    {
       return [
           new Middleware(PermissionMiddleware::using(['head-of-family-menu|head-of-family-list|head-of-family-create|head-of-family-edit|head-of-family-delete']),only: ['index','getAllPaginated' ,'store', 'show', 'update', 'destroy']),
